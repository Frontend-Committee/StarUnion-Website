...
const ProjectCard = ({ project, delay = 0 }) => (
  ...
  <motion.div
    ...
    transition={{ type: "spring", stiffness: 300, damping: 22 }}
    className="w-[220px] rounded-[22px] overflow-hidden border border-purple-500/20 flex flex-col"
    style={{
  ...
  >
    ...
    <div className="px-3 pt-3 pb-2 text-center relative z-10">
    
      <h4 className="text-white  text-[16px] leading-none tracking-tight">
        {project.title}
      </h4>
    </div>
