...
const ProjectCard = ({ project, delay = 0 }) => (
  <ScrollAnimation variant="fade-up" delay={delay} className="flex-shrink-0">
    <motion.div
      ...
      transition={{ type: "spring", stiffness: 300, damping: 22 }}
      className="w-[185px] rounded-[14px] overflow-hidden border border-purple-500/20 bg-[#0d0820] flex flex-col"
      style={{ boxShadow: "0 4px 16px rgba(0,0,0,0.30)" }}
    >
      {/* ── Title on top centered ── */}
      <div className="px-3 pt-3 pb-2 text-center bg-[#0d0820]">
      ...
      <div className="px-3 py-[10px] flex flex-col items-center gap-2 bg-[#0d0820]">
        ...
        <button className="w-full px-3 py-[5px] text-[10px] text-white bg-purple-600 border border-purple-500 rounded-[6px] hover:bg-purple-500/80 transition-colors font-bold whitespace-nowrap text-center">
          View Details
        </button>
      </div>
    </motion.div>
