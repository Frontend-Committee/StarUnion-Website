      ...
      <Link to={`/committees/${committee.slug}`} className="block group h-full">
        ...
        >
          ...
          <div className="px-3 pb-4 pt-1 mx-auto">
            <span className="inline-block px-4 py-[6px] text-[13px] bg-white text-primary border border-primary rounded-md font-medium group-hover:bg-primary transition-colors duration-200">
              View Details
            </span>
          </div>
