...
function ActivityCard({ image, title }) {
  return (
    <div className="relative overflow-hidden rounded-[14px] aspect-[4/3] cursor-pointer group">
      {/* Background image */}
      <img
        src={image}
        alt={title}
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-between p-4">
        ...
        <button className="px-5 py-1.5 mb-1.5 text-xs font-semibold text-white bg-white/18 border border-white/40 rounded-full backdrop-blur-sm hover:bg-white/32 transition-colors duration-200">
          View Details
        </button>
      </div>
    </div>
...
export default function AboutUsPage() {
  ...
  return (
    <div className="w-full overflow-x-hidden bg-[radial-gradient(circle_at_center,_#4D3398_0%,_#241352_40%,_#1E1A2B_100%)]">
      ...
      ══════════════════════════════════════════════════════════════════════ */}
      <section className="relative w-full py-16 overflow-hidden bg-[radial-gradient(circle_at_top,_#241352_0%,_#4D3398_45%,_#1E1A2B_100%)]">
        <div className="container">
          {/* Header row */}
          <div className="flex items-center justify-between mb-8">
            <h2 className="text-tertiary text-2xl font-black m-0">
              Our Committees
            </h2>
      ...
      ══════════════════════════════════════════════════════════════════════ */}
      <section className="w-full py-16 bg-[#1E1A2B]">
        <div className="container">
          <h2 className="text-tertiary text-2xl font-semibold mb-8">What We Do</h2>
