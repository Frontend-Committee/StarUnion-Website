...
<div className="absolute inset-0 bg-[#A28DE2]/45 mix-blend-multiply" />      <div className="absolute inset-0 bg-black/30 group-hover:bg-black/45 transition-colors duration-300" />
