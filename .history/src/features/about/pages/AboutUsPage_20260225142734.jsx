...
function CommitteeDropdown({ label, items }) {
  ...
  return (
    <div className="relative inline-block">
      <button
        onClick={() => setOpen((o) => !o)}
        className="flex items-center gap-2 px-5 py-2.5 border w- justify-center border-white rounded-lg bg-white text-[#1a0a4b] text-sm font-semibold cursor-pointer hover:bg-white/90 transition-colors duration-200"
      >
        {label}
