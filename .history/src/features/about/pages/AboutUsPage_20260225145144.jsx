    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-between py-5 px-4">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className="px-6 py-1.5 text-xs font-semibold text-[#1a0a4b] bg-white border border-white  rounded-lg hover:bg-white/90 transition-colors duration-200 shadow-md"
        >
          View Details
        </motion.button>
      </div>
