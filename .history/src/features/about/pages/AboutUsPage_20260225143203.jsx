    ...
    <div className="w-full overflow-x-hidden bg-[radial-gradient(circle_at_center,_#4D3398_0%,_#241352_40%,_#1E1A2B_100%)]">
      ...
      <section className="py-16">
        <div className="container">
          <h2 className="text-tertiary text-4xl font-semibold mb-4">
            Who We Are
          </h2>
      ...
      <section className="relative w-full py-16 ">
        <div className="container">
          ...
          <div className="flex items-center justify-between mb-8">
            <h2 className="text-tertiary text-4xl font-semibold m-0">
              Our Committees
            </h2>
      ...
      <section className="w-full py-16">
        <div className="container">
          <h2 className="text-tertiary  text-4xl font-semibold mb-8">
            What We Do
          </h2>
