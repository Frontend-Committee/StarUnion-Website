...
<div className="absolute inset-0 bg-[#AFA7C7]/45 mix-blend-multiply" />      <div className="absolute inset-0 bg-black/30 group-hover:bg-black/45 transition-colors duration-300" />
