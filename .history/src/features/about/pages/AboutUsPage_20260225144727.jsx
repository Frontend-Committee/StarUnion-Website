  ...
  return (
    <div className="relative inline-block">
      <motion.button
        onClick={() => setOpen((o) => !o)}
        whileTap={{ scale: 0.97 }}
        className="flex items-center gap-2 px-5 py-2.5 border w-80 justify-center border-white rounded-lg bg-white text-primary/90  text-sm font-bold cursor-pointer hover:bg-white/90 transition-colors duration-200"
      >
        {label}
