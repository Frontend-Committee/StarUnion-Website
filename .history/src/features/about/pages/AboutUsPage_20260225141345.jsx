...
function ActivityCard({ image, title }) {
  return (
    <div className="relative overflow-hidden rounded-[10px] aspect-square cursor-pointer group">
      <img
        src={image}
        alt={title}
...
export default function AboutUsPage() {
  ...
  <div className="container">
    ...
    <div className="grid grid-cols-2 gap-3 max-w-[620px]">
      {activities.map((act) => (
        <ActivityCard key={act.title} image={act.image} title={act.title} />
      ))}
    </div>
  </div>
</section>
