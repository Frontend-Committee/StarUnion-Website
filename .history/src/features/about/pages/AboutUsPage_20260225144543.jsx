        ...
        >
          {items.map((item, i) => (
            <motion.button
              ...
              className="block w-full text-left px-4 py-2.5 text-xs text-primary hover:text-white/35 bg-transparent border-none cursor-pointer hover:bg-white/9 transition duration-150"
            >
              {item}
            </motion.button>
          ))}
